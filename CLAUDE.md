...
- Translation/localization Skill (binding for **all** translation and multilingual work, adopted by Seung Park 2026-08-03): `.claude/skills/general-translation-skill/SKILL.md` — creative copy culturally localized (Mode A), accuracy-critical content strictly translated (Mode B), mixed content split and verified (Mode C). Project refinements: `.claude/skills/general-translation-skill/adapters/mytaxfile.md`. Its presence does not authorize multilingual implementation (area 18 — site remains English-only until separately approved).
